...
function Navbar() {
  ...
  <div className="mx-auto flex max-w-7xl items-center justify-between px-1 py-1 sm:px-6 lg:px-8">
    <div className="inline-flex items-center space-x-2">
      <span >
        <img src="src/photos/logo.png" alt="" className="w-44 max-md:w-28"/>
      </span>
    </div>
    <div className="hidden lg:block ">
      <ul class=" ml-100 inline-flex space-x-8">
        <li>
          <a
            href="servicepage"
            className="text-sm max-md:text-xs text-gray-800 hover:text-gray-900"
          >
            Services
          </a>
        </li>
